...
const jobContacts = sqliteTable("job_contacts", {
  jobId: text("job_id").notNull().references(() => jobs.id, { onDelete: "cascade" }),
  contactId: text("contact_id").notNull().references(() => contacts.id, { onDelete: "cascade" }),
  relationshipType: text("relationship_type").notNull()
});
const jobStatusHistory = sqliteTable("job_status_history", {
  id: text("id").primaryKey(),
  jobId: text("job_id").notNull().references(() => jobs.id, { onDelete: "cascade" }),
...
const contactsRelations = relations(contacts, ({ one, many }) => ({
  company: one(companies, {
...
const jobContactsRelations = relations(jobContacts, ({ one }) => ({
  job: one(jobs, {
...
const jobStatusHistoryRelations = relations(jobStatusHistory, ({ one }) => ({
  job: one(jobs, {
...
const schema = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  contactsRelations,
  jobContacts,
  jobContactsRelations,
  jobStatusHistory,
  jobStatusHistoryRelations,
  jobs,
  jobsRelations
...
function initializeDatabase(dbPath) {
  ...
  const sqlite = new Client(finalDbPath);
